...
CREATE TABLE `Zapsani_zaci` (
  ...
  `id_autoskoly` INT,
  `id_zaka` INT,
  FOREIGN KEY (`id_terminu`) REFERENCES `Terminy` (`id`),
  FOREIGN KEY (`id_komisare`) REFERENCES `Komisari` (`id`),
  FOREIGN KEY (`id_autoskoly`) REFERENCES `Autoskoly` (`id`),
  FOREIGN KEY (`id_zaka`) REFERENCES `Zaci` (`id`)
);
...
-- ALTER TABLE `Upozorneni` ADD FOREIGN KEY (`id_autoskoly`) REFERENCES `Autoskoly` (`id`);
